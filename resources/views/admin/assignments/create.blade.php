...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-800">
            <i class="fas fa-user-plus"></i> Create New Task Assignment
        </h1>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('admin.assignments.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="datetime-local" name="assigned_at" id="assigned_at" value="{{ old('assigned_at', now()->format('Y-m-d\TH:i')) }}"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                <p class="text-gray-500 text-xs mt-1">Leave as default for current time</p>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="datetime-local" name="completed_at" id="completed_at" value="{{ old('completed_at') }}"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                <p class="text-gray-500 text-xs mt-1">Only fill if task is already completed</p>
            </div>
